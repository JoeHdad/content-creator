...
export const HeroSection = () => {
  ...
  return <section className="min-h-screen bg-gradient-hero flex items-center relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          ease: "easeOut"
            ...
            <div className="relative">
              ...
              <img alt="Yousef Alhaddad - Content Creator & AI Creative Technologist" className="relative w-72 h-72 sm:w-80 sm:h-80 lg:w-96 lg:h-96 object-cover rounded-full shadow-elevated" src="/lovable-uploads/a9b809d5-8461-4abe-a808-d3f674f88448.png" />
            </div>
          </motion.div>
      ...
      duration: 0.5
        ...
        <button onClick={scrollToAbout} className="flex flex-col items-center gap-2 text-muted-foreground hover:text-primary transition-colors" aria-label="Scroll to about section">
