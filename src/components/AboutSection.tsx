...
export const AboutSection = () => {
  ...
  return <section id="about" className="py-24 bg-secondary/30" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          delay: 0.2
            ...
            <p className="text-body-lg text-muted-foreground">I'm a content creator and AI creative technologist from Gaza, with a unique blend of technical expertise and creative vision. My journey began with a BSc in Computer Science from the Islamic University of Gaza, where I discovered my passion for bridging the gap between technology and storytelling.</p>
