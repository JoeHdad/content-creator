...
const socialLinks = [
  { icon: Linkedin, href: "https://linkedin.com/in/yousef-alhaddad", label: "LinkedIn" },
  { icon: Instagram, href: "https://instagram.com/yousef.alhaddad", label: "Instagram" },
  { icon: Twitter, href: "https://twitter.com/yousef_alhaddad", label: "X (Twitter)" },
  { icon: Youtube, href: "https://youtube.com/@yousefalhaddad", label: "YouTube" },
];
    ...
    <section id="contact" className="py-24 bg-secondary/30" ref={ref}>
      <div className="container mx-auto px-6">
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 max-w-5xl mx-auto">
          ...
          >
            {isSubmitted ? (
              <div className="bg-background rounded-2xl p-12 shadow-subtle text-center">
              ...
              <form onSubmit={handleSubmit} className="bg-background rounded-2xl p-8 shadow-subtle">
          ...
          >
            ...
            <div className="bg-background rounded-2xl p-8 shadow-subtle">
              ...
              <div className="space-y-4">
                <a
                  href="mailto:hello@yousefalhaddad.com"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-foreground font-medium">hello@yousefalhaddad.com</div>
                  </div>
                </a>
                ...
                {socialLinks.map((social) => {
                  ...
                  return (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex items-center gap-3 p-4 rounded-xl bg-secondary/50 hover:bg-primary hover:text-primary-foreground transition-all group"
                    >
